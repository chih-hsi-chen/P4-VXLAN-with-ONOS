...
################# Custom P4Switch Configuration #################
def configureBMv2Switch(**switch_args):
    if "sw_path" in switch_args and 'grpc' in switch_args['sw_path']:
        # If grpc appears in the BMv2 switch target, we assume will start P4Runtime
        class ConfiguredP4RuntimeSwitch(ONOSBmv2Switch):
            def __init__(self, *opts, **kwargs):
                kwargs.update(switch_args)
                ONOSBmv2Switch.__init__(self, *opts, **kwargs)
...
class ExerciseRunner:
    ...
    def create_network(self):
        ...
        defaultSwitchClass = configureBMv2Switch(
        ...
        self.net = Mininet(topo = self.topo,
                      ...
                      controller = None)
        self.net.addController(controller = RemoteController,
                               ip = "127.0.0.1")
